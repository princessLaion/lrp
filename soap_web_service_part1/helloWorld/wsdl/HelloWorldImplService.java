...
import com.lea.soap.tutorial.helloWorld.HelloWorld;
 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://helloWorld.tutorial.soap.lea.com/", wsdlLocation = "http://localhost:9998/ws/helloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://helloWorld.tutorial.soap.lea.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9998/ws/helloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://helloWorld.tutorial.soap.lea.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloWorld.tutorial.soap.lea.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
